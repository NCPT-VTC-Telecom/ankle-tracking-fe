...
export const TablePagination = ({
  ...
  // Đồng bộ currentPage với pageIndex prop khi pageIndex thay đổi (search, filter)
  useEffect(() => {
      ...
      <div>
        <div className="flex items-center justify-between">
          <Typography variant="body1" color="secondary">
            {intl.formatMessage(
              { id: 'display-range' },
              { start, end, total: <span className="font-semibold text-blue-500"> {formatNumberWithUnits(totalResults || 0)} </span> }
            )}
          </Typography>
