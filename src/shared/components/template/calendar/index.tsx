...
import { getEvents, selectEvent, selectRange, toggleModal, updateCalendarView, updateEvent } from 'shared/store/reducers/calendar';
    ...
    <Box sx={{ position: 'relative' }}>
      <CalendarStyled>
        ...
        <FullCalendar
          ...
          noEventsContent={intl.formatMessage({ id: 'no-event' })}
        />
      </CalendarStyled>
      ...
      <Tooltip title={intl.formatMessage({ id: 'add-event' })}>
        <SpeedDial
