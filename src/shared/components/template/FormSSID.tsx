...
// types
import { FieldConfig, OptionList } from 'shared/types';
...
import { Input, Switch } from 'shared/components/molecules/form';
...
const FormVoucher = ({ onCancel, formik, title, ssidOptions, siteOptions, radiusOptions, isEditMode }: Props) => {
                        ...
                        <Grid container spacing={2} className="mt-2">
                          ...
                          <Grid item xs={6} className="mt-8">
                            <FormControl fullWidth>
                              ...
                              >
                                <MenuItem value={1}>{intl.formatMessage({ id: 'min' })}</MenuItem>
